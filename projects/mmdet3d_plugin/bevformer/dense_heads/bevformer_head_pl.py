...
class BEVFormerHeadPL():#DETRHead
    """Head of Detr3D.
    Args:
    ...
    def __init__(self,
        ...
        # --- positional encoding ---
        pos_enc_cfg = dict(type='SinePositionalEncoding',
                           num_feats=self.embed_dims // 2,
                           normalize=True)
        self.positional_encoding = build_positional_encoding(pos_enc_cfg)
    ...
    #     # super(BEVFormerHeadPL, self).__init__(
